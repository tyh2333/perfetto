...
class MockProducerEndpoint : public TracingService::ProducerEndpoint {
 public:
  ...
  MOCK_METHOD(void, RegisterDataSource, (const DataSourceDescriptor&), (override));
  MOCK_METHOD(void, UpdateDataSource, (const DataSourceDescriptor&), (override));
  ...
  MOCK_METHOD(void, CommitData, (const CommitDataRequest&, CommitDataCallback), (override));
  MOCK_METHOD(SharedMemory*, shared_memory, (), (const, override));
  MOCK_METHOD(size_t, shared_buffer_page_size_kb, (), (const, override));
  MOCK_METHOD(std::unique_ptr<TraceWriter>, CreateTraceWriter, (BufferID, BufferExhaustedPolicy), (override));
  ...
  MOCK_METHOD(void, NotifyDataSourceStarted, (DataSourceInstanceID), (override));
  MOCK_METHOD(void, NotifyDataSourceStopped, (DataSourceInstanceID), (override));
  MOCK_METHOD(void, ActivateTriggers, (const std::vector<std::string>&), (override));
