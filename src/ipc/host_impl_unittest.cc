...
class FakeService : public Service {
 public:
  MOCK_METHOD(void, OnFakeMethod1, (const RequestProto&, DeferredBase*), (override));
...
class FakeClient : public base::UnixSocket::EventListener {
 public:
  ...
  MOCK_METHOD(void, OnServiceBound, (const Frame::BindServiceReply&), (override));
  MOCK_METHOD(void, OnInvokeMethodReply, (const Frame::InvokeMethodReply&), (override));
  MOCK_METHOD(void, OnFileDescriptorReceived, (int), (override));
  MOCK_METHOD(void, OnRequestError, (), (override));
