...
class MockDs2Callbacks : testing::Mock {
 public:
  MOCK_METHOD(void*, OnSetup, (PerfettoDsInstanceIndex inst_id,
                     void* ds_config,
                     size_t ds_config_size,
                     void* user_arg), (override));
  MOCK_METHOD(void, OnStart, (PerfettoDsInstanceIndex inst_id,
                    void* user_arg,
                    void* inst_ctx), (override));
  MOCK_METHOD(void, OnStop, (PerfettoDsInstanceIndex inst_id,
                    void* user_arg,
                    void* inst_ctx,
                    struct PerfettoDsOnStopArgs* args), (override));
  MOCK_METHOD(void*, OnCreateTls, (PerfettoDsInstanceIndex inst_id,
                     struct PerfettoDsTracerImpl* tracer,
                     void* user_arg), (override));
  MOCK_METHOD(void, OnDeleteTls, (void*), (override));
  MOCK_METHOD(void*, OnCreateIncr, (PerfettoDsInstanceIndex inst_id,
                     struct PerfettoDsTracerImpl* tracer,
                     void* user_arg), (override));
  MOCK_METHOD(void, OnDeleteIncr, (void*), (override));
};
