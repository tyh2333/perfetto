...
class MockFtraceProcfs : public FtraceProcfs {
 public:
  ...
  MOCK_METHOD(bool, WriteToFile, (const std::string& path, const std::string& str), (override));
  MOCK_METHOD(bool, AppendToFile, (const std::string& path, const std::string& str), (override));
  ...
  MOCK_METHOD(std::string, ReadFileIntoString, (const std::string& path), (const, override));
  MOCK_METHOD(size_t, NumberOfCpus, (), (const, override));
  MOCK_METHOD(const std::set<std::string>, GetEventNamesForGroup, (const std::string& path), (const, override));
  MOCK_METHOD(std::string, ReadEventFormat, (const std::string& group,
 ...
 public:
  MockProtoTranslationTable(NiceMock<MockFtraceProcfs>* ftrace_procfs,
      ...
      : ProtoTranslationTable(ftrace_procfs,
                              ...
                              PrintkMap()) {}
  MOCK_METHOD(Event*, GetOrCreateEvent, (const GroupAndName& group_and_name), (override));
  MOCK_METHOD(const Event*, GetEvent, (const GroupAndName& group_and_name), (const, override));
};
