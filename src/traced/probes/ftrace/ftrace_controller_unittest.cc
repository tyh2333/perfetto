...
class MockTaskRunner : public base::TaskRunner {
 public:
  ...
  MOCK_METHOD(void, PostDelayedTask, (std::function<void()>, uint32_t delay_ms), (override));
  MOCK_METHOD(void, AddFileDescriptorWatch, (int fd, std::function<void()>), (override));
